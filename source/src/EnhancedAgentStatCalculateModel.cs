...
namespace EnhancedMissionMoreOptionsPlugin
{
    public class EnhancedAgentStatCalculateModel : AgentStatCalculateModel
    {
            ...
            AgentDrivenProperties agentDrivenProperties)
        {
            ...
            {
                float meleeAILevel = MathF.Clamp(config.MeleeAI / 100.0f, 0, 1);
                ...
                agentDrivenProperties.AIBlockOnDecideAbility = MBMath.Lerp(0.05f, 0.95f, MBMath.ClampFloat((float)Math.Pow((double)meleeAILevel, 4.0), 0.0f, 1f), 1E-05f);
                agentDrivenProperties.AIParryOnDecideAbility = MBMath.Lerp(0.01f, 0.95f, MBMath.ClampFloat((float)Math.Pow((double)meleeAILevel, 4.0) + num2, 0.0f, 1f), 1E-05f);
                ...
                agentDrivenProperties.AIParryOnAttackAbility = MBMath.ClampFloat((float)Math.Pow((double)meleeAILevel, 5.0), 0.0f, 1f);
                ...
                agentDrivenProperties.AIParryOnAttackingContinueAbility = MBMath.Lerp(0.05f, 0.95f, MBMath.ClampFloat((float)Math.Pow((double)meleeAILevel, 5.0), 0.0f, 1f), 1E-05f);
                agentDrivenProperties.AIDecideOnRealizeEnemyBlockingAttackAbility = 0.5f * MBMath.ClampFloat((float)Math.Pow((double)meleeAILevel, 4.0) - 0.1f, 0.0f, 1f);
                agentDrivenProperties.AIRealizeBlockingFromIncorrectSideAbility = 0.5f * MBMath.ClampFloat((float)Math.Pow((double)meleeAILevel, 4.0) - 0.1f, 0.0f, 1f);
            ...
            {
                float RangedAILevel = MathF.Clamp(config.RangedAI / 100.0f, 0, 1);
