...
namespace ImprovedCombatAI
{
    public class ImprovedCombatAIAgentStatCalculateModel : AgentStatCalculateModel
    {
            ...
            AgentDrivenProperties agentDrivenProperties)
        {
            ...
            agentDrivenProperties.AiCheckMovementIntervalFactor = config.EnableCheckMovementIntervalFactor ? config.CheckMovementIntervalFactor * 0.005f : (float)(0.00499999988824129 * (1.10000002384186 - meleeAILevel));
            ...
            agentDrivenProperties.AiMoveEnemySideTimeValue = config.EnableAiMoveEnemySideTimeValue ? config.AiMoveEnemySideTimeValue : (float)(0.5 * meleeAILevel - 2.5);
            agentDrivenProperties.AiMinimumDistanceToContinueFactor = config.EnableAiMinimumDistanceToContinueFactor ? config.AiMinimumDistanceToContinueFactor : (float)(2.0 + 0.300000011920929 * (3.0 - meleeAILevel));
            agentDrivenProperties.AiStandGroundTimerValue = config.EnableAiStandGroundTimerValue ? config.AiStandGroundTimerValue : (float)(0.5 * (meleeAILevel - 1.0));
            agentDrivenProperties.AiStandGroundTimerMoveAlongValue = config.EnableAiStandGroundTimerMoveAlongValue ? config.AiStandGroundTimerMoveAlongValue : (float)(0.5 * meleeAILevel - 1.0);
